...
namespace App.DAL.EF.Migrations
{
    ...
    [Migration("20220522103740_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.AgeRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Domain.CastInMovie", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Domain.CastRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Domain.MovieDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Domain.MovieType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Domain.PaymentDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Domain.ProfileFavoriteMovie", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Domain.ProfileMovie", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Domain.CastInMovie", b =>
                {
                    b.HasOne("App.Domain.CastRole", "CastRole")
                        .WithMany()
                    ...
                    b.HasOne("App.Domain.Person", "Persons")
                        .WithMany()
            ...
            modelBuilder.Entity("App.Domain.MovieDetails", b =>
                {
                    b.HasOne("App.Domain.AgeRating", "AgeRating")
                        .WithMany()
                        .HasForeignKey("AgeRatingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App.Domain.MovieType", "MovieType")
                        .WithMany()
            ...
            modelBuilder.Entity("App.Domain.UserSubscription", b =>
                {
                    ...
                    b.HasOne("App.Domain.Subscription", "Subscription")
                        .WithMany()
