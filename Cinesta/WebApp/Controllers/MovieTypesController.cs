...
namespace WebApp.Controllers
{
    public class MovieTypesController : Controller
    {
        ...
        // GET: MovieTypes/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: MovieTypes/Create
